...
ThemeData darkTheme = ThemeData(
  ...
  colorScheme: const ColorScheme(
    primary: AppDarkColors.backgroundColor,
    // 主色的变体
    secondary: AppDarkColors.grayColor,
    // 辅助色的变体
    ...
    error: Colors.red,
    // 错误色
    onPrimary: AppDarkColors.titleColor,
    // 在主色上的文本颜色
    onSecondary: Colors.white,
    // 在辅助色上的文本颜色
    onSurface: AppDarkColors.backgroundColor,
    // 在表面色上的文本颜色
    onBackground: AppDarkColors.titleColor,
    // 在背景色上的文本颜色
